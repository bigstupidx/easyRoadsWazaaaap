...
public class GameSettings{
	...
	static float[] listTime_3 = {90, 140, 160, 120, 90, 150, 115, 70, 86, 102, 100, 90, 120, 120, 180};
	static float[] listTime_2 = {105, 160, 180, 135, 105, 160, 130, 85, 100, 115, 115, 105, 135, 135, 195};
	static float[] listTime_1 = {120, 180, 200, 150, 120, 180, 145, 100, 115, 130, 130, 120, 150, 150, 210};
