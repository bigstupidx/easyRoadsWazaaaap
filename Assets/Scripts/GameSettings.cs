...
public class GameSettings{
	...
	static float[] listTime_3 = {105, 105, 175, 135, 155, 165, 130, 135, 155, 140, 105, 105, 175, 135, 155, 165, 130, 135, 155, 140};
	static float[] listTime_2 = {120, 120, 195, 150, 175, 175, 145, 150, 165, 150, 120, 120, 195, 150, 175, 175, 145, 150, 165, 150};
	static float[] listTime_1 = {135, 135, 215, 165, 195, 195, 160, 165, 180, 165, 135, 135, 215, 165, 195, 195, 160, 165, 180, 165};
	// set level for unlocking next bike
	static int[] listUnlockingBike = {1,2,4,6}; // {1,2,4,12};
